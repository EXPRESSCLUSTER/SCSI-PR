...
- Download the scripts for EXPRESSCLUSTER shared disk with SCSI persistent reservation (including start.bat, attacker.ps1, genw.bat, defender.ps1). Also download the SCSI-PR utility, sg_persist.exe.    
